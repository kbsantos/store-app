...
class StoreManagementLoginPage extends StatefulWidget {
  ...
  @override
  State<StoreManagementLoginPage> createState() => _StoreManagementLoginPageState();
}
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Icon(Icons.storefront_outlined, size: 72, color: gold),
                    const SizedBox(height: 12),
                    const Text('BIGGER BREW', textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.w900, letterSpacing: 2)),
                    const SizedBox(height: 4),
                    const Text('STORE MANAGEMENT', textAlign: TextAlign.center,
                    ...
                    FilledButton.icon(
                      ...
                      icon: _busy ? const SizedBox(width: 18, height: 18, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : const Icon(Icons.login),
